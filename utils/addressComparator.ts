...
export function addressComparator(addressA: string, addressB: string, dir: 'ASC' | 'DESC' = 'ASC'): number {
...
// example of using addressComparator
export function sortAddresses(addresses) {
  return addresses.sort(addressComparator);
}
